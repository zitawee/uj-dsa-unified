...
function buildQField(f) {
  ...
  if(f.t==='textarea')
    return `<div class="fg full"><label>${f.l}</label><textarea id="${id}" rows="3" style="resize:vertical;font-family:inherit;width:100%;padding:7px 10px;border:1px solid var(--border);border-radius:var(--r)" placeholder="اكتب الاسم الأول ثم..."></textarea></div>`;
