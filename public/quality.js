...
const QCFG = {
  ...
  workshops:{title:'الدورات وورش العمل والمحاضرات والبرامج',cols:['name','authority','date','students_count','external_party','rating'],heads:['النشاط','الجهة','التاريخ','الطلبة','جهة خارجية','التقييم'],fields:[{l:'اسم النشاط*',id:'name',t:'text'},{l:'الجهة المنظِّمة',id:'authority',t:'text'},{l:'التاريخ*',id:'date',t:'date'},{l:'عدد الطلبة الحاضرين',id:'students_count',t:'number'},{l:'أسماء العاملين (Enter لسطر جديد)',id:'staff_names',t:'textarea'},{l:'أسماء القيادات (Enter لسطر جديد)',id:'leaders_names',t:'textarea'},{l:'جهة خارجية',id:'external_party',t:'yesno'},{l:'رقم تقييم النشاط',id:'rating',t:'number'}]},
  initiatives:{title:'مبادرات الإبداع والابتكار والريادة',cols:['name','type','date','participants_count','attendees_count','rating'],heads:['المبادرة','النوع','التاريخ','المشاركون','الحاضرون','التقييم'],fields:[{l:'اسم المبادرة*',id:'name',t:'text'},{l:'نوع المبادرة',id:'type',t:'text'},{l:'التاريخ*',id:'date',t:'date'},{l:'عدد الطلبة المشاركين',id:'participants_count',t:'number'},{l:'عدد الطلبة الحاضرين',id:'attendees_count',t:'number'},{l:'أسماء القيادات (Enter لسطر جديد)',id:'leaders_names',t:'textarea'},{l:'جهة خارجية',id:'external_party',t:'yesno'},{l:'رقم تقييم النشاط',id:'rating',t:'number'}]},
  external_acts:{title:'مشاركة الطلبة في الأنشطة الإبداعية الخارجية',cols:['name','type','date','students_count','external_party','rating'],heads:['النشاط','النوع','التاريخ','الطلبة','جهة خارجية','التقييم'],fields:[{l:'اسم النشاط*',id:'name',t:'text'},{l:'نوع النشاط',id:'type',t:'text'},{l:'التاريخ*',id:'date',t:'date'},{l:'عدد الطلبة الحاضرين',id:'students_count',t:'number'},{l:'أسماء القيادات (Enter لسطر جديد)',id:'leaders_names',t:'textarea'},{l:'جهة خارجية',id:'external_party',t:'yesno'},{l:'رقم تقييم النشاط',id:'rating',t:'number'}]},
  competitions:{title:'الأنشطة التي تعد الطلبة للمنافسات المحلية والدولية',cols:['name','type','date','students_count','trainer'],heads:['النشاط','النوع','التاريخ','الطلبة','المدرب'],fields:[{l:'اسم النشاط*',id:'name',t:'text'},{l:'نوع النشاط',id:'type',t:'text'},{l:'التاريخ*',id:'date',t:'date'},{l:'عدد الطلبة المشاركين',id:'students_count',t:'number'},{l:'اسم المدرب',id:'trainer',t:'text'},{l:'أسماء العاملين (Enter لسطر جديد)',id:'staff_names',t:'textarea'},{l:'جهة خارجية',id:'external_party',t:'yesno'}]},
  ...
  awareness:{title:'الأنشطة والمحاضرات التوعوية',cols:['name','type','date','external_party','rating'],heads:['النشاط','النوع','التاريخ','جهة خارجية','التقييم'],fields:[{l:'اسم النشاط*',id:'name',t:'text'},{l:'نوع النشاط',id:'type',t:'select',opts:['ديني','توعوي','وطني','تثقيفي']},{l:'التاريخ*',id:'date',t:'date'},{l:'أسماء القيادات (Enter لسطر جديد)',id:'leaders_names',t:'textarea'},{l:'أسماء العاملين (Enter لسطر جديد)',id:'staff_names',t:'textarea'},{l:'جهة خارجية',id:'external_party',t:'yesno'},{l:'رقم تقييم النشاط',id:'rating',t:'number'}]},
  expert_acts:{title:'الأنشطة التي شارك بها الخبراء من المجتمع',cols:['name','date','authority','students_count','rating'],heads:['النشاط','التاريخ','الجهة','الطلبة','التقييم'],fields:[{l:'اسم النشاط*',id:'name',t:'text'},{l:'التاريخ*',id:'date',t:'date'},{l:'الجهة',id:'authority',t:'text'},{l:'عدد الطلبة',id:'students_count',t:'number'},{l:'أسماء الخبراء',id:'experts_names',t:'text'},{l:'أسماء العاملين (Enter لسطر جديد)',id:'staff_names',t:'textarea'},{l:'أسماء القيادات (Enter لسطر جديد)',id:'leaders_names',t:'textarea'},{l:'رقم تقييم النشاط',id:'rating',t:'number'}]},
  environment:{title:'أنشطة البيئة والتنمية المستدامة',cols:['name','authority','date','students_count','rating'],heads:['النشاط','الجهة','التاريخ','الطلبة','التقييم'],fields:[{l:'اسم النشاط*',id:'name',t:'text'},{l:'الجهة',id:'authority',t:'text'},{l:'التاريخ*',id:'date',t:'date'},{l:'عدد الطلبة المشاركين',id:'students_count',t:'number'},{l:'أسماء العاملين (Enter لسطر جديد)',id:'staff_names',t:'textarea'},{l:'أسماء القيادات (Enter لسطر جديد)',id:'leaders_names',t:'textarea'},{l:'جهة خارجية',id:'external_party',t:'text'},{l:'رقم تقييم النشاط',id:'rating',t:'number'}]},
  dialogues:{title:'الجلسات الحوارية عن التشريعات السياسية',cols:['title','date','students_count','rating'],heads:['العنوان','التاريخ','الطلبة','التقييم'],fields:[{l:'عنوان الجلسة*',id:'title',t:'text'},{l:'التاريخ*',id:'date',t:'date'},{l:'المتحدثون',id:'speakers',t:'text'},{l:'عدد الطلبة المشاركين',id:'students_count',t:'number'},{l:'أسماء العاملين (Enter لسطر جديد)',id:'staff_names',t:'textarea'},{l:'أسماء القيادات (Enter لسطر جديد)',id:'leaders_names',t:'textarea'},{l:'رقم تقييم النشاط',id:'rating',t:'number'}]},
  campaigns:{title:'الحملات التوعوية والتثقيفية',cols:['title','date','external_party','students_count'],heads:['العنوان','التاريخ','الجهة الخارجية','الطلبة'],fields:[{l:'عنوان الحملة*',id:'title',t:'text'},{l:'التاريخ*',id:'date',t:'date'},{l:'الجهة الخارجية',id:'external_party',t:'text'},{l:'أسماء المتحدثين',id:'speakers',t:'text'},{l:'عدد الطلبة المشاركين',id:'students_count',t:'number'},{l:'أسماء العاملين (Enter لسطر جديد)',id:'staff_names',t:'textarea'},{l:'أسماء القيادات (Enter لسطر جديد)',id:'leaders_names',t:'textarea'}]},
};
