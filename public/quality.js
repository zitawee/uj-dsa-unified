...
const QCFG = {
  ...
  campaigns:{title:'الحملات التوعوية والتثقيفية',cols:['title','date','external_party','students_count'],heads:['العنوان','التاريخ','الجهة الخارجية','الطلبة'],fields:[{l:'عنوان الحملة*',id:'title',t:'text'},{l:'التاريخ*',id:'date',t:'date'},{l:'جهة خارجية',id:'external_party',t:'yesno'},{l:'اسم الجهة الخارجية',id:'ext_name',t:'text'},{l:'أسماء المشاركين من الخارج',id:'ext_people',t:'textarea'},{l:'أسماء المتحدثين',id:'speakers',t:'textarea'},{l:'عدد الطلبة المشاركين',id:'students_count',t:'number'},{l:'أسماء العاملين',id:'staff_names',t:'textarea'},{l:'أسماء القيادات',id:'leaders_names',t:'textarea'}]},
};
