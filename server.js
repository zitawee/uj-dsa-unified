...
const SPORTS_MODEL_RANK_SCORES = {
  ...
  7: { 'الأول': 14, 'الثاني': 13, 'الثالث': 11, 'الرابع فما فوق': 10 },
  8: { fixed: 10 },
};
...
const SPORTS_GAME_TYPES = ['كرة الطائرة','كرة السلة','كرة اليد','كرة القدم','كرة الطاولة','ألعاب القوى','التايكوندو','الكراتيه','الريشة الطائرة','الشطرنج','التنس'];
